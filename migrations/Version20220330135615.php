 ...
 */
final class Version20220330135615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE setting_options (id INT AUTO_INCREMENT NOT NULL, payments_singleline INT DEFAULT NULL, payments_direct INT DEFAULT NULL, cash_back INT DEFAULT NULL, all_price_pakage INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
