 ...
 */
final class Version20220414135557 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE setting_options ADD start_day INT DEFAULT NULL, ADD fast_start INT DEFAULT NULL, ADD update_day INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE setting_options DROP start_day, DROP fast_start, DROP update_day');
