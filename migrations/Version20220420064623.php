 ...
 */
final class Version20220420064623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD secret_code VARCHAR(255) DEFAULT NULL');
    }
