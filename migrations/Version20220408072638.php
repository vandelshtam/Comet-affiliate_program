 ...
 */
final class Version20220408072638 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD pakage_status INT DEFAULT NULL');
