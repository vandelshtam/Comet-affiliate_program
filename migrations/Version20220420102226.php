 ...
 */
final class Version20220420102226 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE setting_options CHANGE multi_pakage_day multi_pakage_day DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE setting_options CHANGE multi_pakage_day multi_pakage_day INT DEFAULT NULL, CHANGE name_multi_pakage name_multi_pakage VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
