 ...
 */
final class Version20220317111809 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rewards (id INT AUTO_INCREMENT NOT NULL, rewards_usdt INT DEFAULT NULL, rewards_token INT DEFAULT NULL, user_id INT DEFAULT NULL, personal_data_id INT DEFAULT NULL, referral_network_id INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
