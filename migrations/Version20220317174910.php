 ...
 */
final class Version20220317174910 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE list_referral_networks ADD pakege_id INT NOT NULL');
        $this->addSql('ALTER TABLE list_referral_networks ADD CONSTRAINT FK_87858524658941E6 FOREIGN KEY (pakege_id) REFERENCES pakege (id)');
        $this->addSql('CREATE INDEX IDX_87858524658941E6 ON list_referral_networks (pakege_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE list_referral_networks DROP FOREIGN KEY FK_87858524658941E6');
        $this->addSql('DROP INDEX IDX_87858524658941E6 ON list_referral_networks');
        $this->addSql('ALTER TABLE list_referral_networks DROP pakege_id, CHANGE name name VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE owner_name owner_name VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE referral_network CHANGE name name VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE user_status user_status VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
