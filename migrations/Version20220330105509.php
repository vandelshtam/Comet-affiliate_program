 ...
 */
final class Version20220330105509 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE referral_network ADD payments_cash INT DEFAULT NULL');
    }
