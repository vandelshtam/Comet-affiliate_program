 ...
 */
final class Version20220319105700 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE referral_network ADD reward INT DEFAULT NULL');
    }
