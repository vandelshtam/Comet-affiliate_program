 ...
 */
final class Version20220411114657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE referral_network CHANGE reward reward INT DEFAULT NULL, CHANGE cash cash INT DEFAULT NULL, CHANGE direct direct INT DEFAULT NULL, CHANGE reward_wallet reward_wallet INT DEFAULT NULL, CHANGE withdrawal_to_wallet withdrawal_to_wallet INT DEFAULT NULL');
        $this->addSql('ALTER TABLE wallet CHANGE usdt usdt INT DEFAULT NULL, CHANGE etherium etherium DOUBLE PRECISION DEFAULT NULL, CHANGE bitcoin bitcoin DOUBLE PRECISION DEFAULT NULL, CHANGE cometpoin cometpoin DOUBLE PRECISION DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE referral_network CHANGE name name VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE user_status user_status VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE network_code network_code VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE member_code member_code VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE reward reward INT DEFAULT 0, CHANGE cash cash INT DEFAULT 0, CHANGE direct direct INT DEFAULT 0, CHANGE my_team my_team VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE reward_wallet reward_wallet INT DEFAULT 0, CHANGE withdrawal_to_wallet withdrawal_to_wallet INT DEFAULT 0');
        ...
        $this->addSql('ALTER TABLE wallet CHANGE usdt usdt INT DEFAULT 0, CHANGE etherium etherium DOUBLE PRECISION DEFAULT \'0\', CHANGE bitcoin bitcoin DOUBLE PRECISION DEFAULT \'0\', CHANGE cometpoin cometpoin DOUBLE PRECISION DEFAULT \'0\'');
    }
}
