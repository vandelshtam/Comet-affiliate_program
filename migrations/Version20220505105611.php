 ...
 */
final class Version20220505105611 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction_table CHANGE cash cash INT DEFAULT NULL, CHANGE withdrawal withdrawal DOUBLE PRECISION DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction_table CHANGE cash cash VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE withdrawal withdrawal INT DEFAULT NULL');
