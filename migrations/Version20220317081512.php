 ...
 */
final class Version20220317081512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pakege ADD CONSTRAINT FK_ABEDE3E1A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_ABEDE3E1A76ED395 ON pakege (user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pakege DROP FOREIGN KEY FK_ABEDE3E1A76ED395');
        $this->addSql('DROP INDEX IDX_ABEDE3E1A76ED395 ON pakege');
