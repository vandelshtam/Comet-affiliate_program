 ...
 */
final class Version20220505083447 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction_table ADD pakage_price INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction_table DROP pakage_price, CHANGE cash cash VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
