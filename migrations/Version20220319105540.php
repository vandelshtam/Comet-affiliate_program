 ...
 */
final class Version20220319105540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE referral_network ADD user_referral_id INT DEFAULT NULL, ADD network_referral_id INT DEFAULT NULL');
    }
