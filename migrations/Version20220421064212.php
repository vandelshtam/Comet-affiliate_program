 ...
 */
final class Version20220421064212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pakege ADD action INT DEFAULT NULL');
    }
