 ...
 */
final class Version20220415070545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pakege DROP created_at, DROP updated_at');
    }
