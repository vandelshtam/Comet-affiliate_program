 ...
 */
final class Version20220328150139 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE referral_network ADD cash INT DEFAULT NULL, ADD direct INT DEFAULT NULL');
    }
