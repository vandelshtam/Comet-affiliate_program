 ...
 */
final class Version20220411121212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pkege ADD user_id INT NOT NULL');
        $this->addSql('ALTER TABLE pkege ADD CONSTRAINT FK_8AAF06ACA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8AAF06ACA76ED395 ON pkege (user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pkege DROP FOREIGN KEY FK_8AAF06ACA76ED395');
        $this->addSql('DROP INDEX UNIQ_8AAF06ACA76ED395 ON pkege');
        $this->addSql('ALTER TABLE pkege DROP user_id');
