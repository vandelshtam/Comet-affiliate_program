 ...
 */
final class Version20220505064741 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction_table ADD network_activation_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction_table DROP network_activation_id, CHANGE cash cash VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
