 ...
 */
final class Version20220330085242 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE referral_network ADD current_network_profit INT DEFAULT NULL, ADD payments_network INT DEFAULT NULL');
    }
