 ...
 */
final class Version20220415063244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pakege ADD updated_at DATETIME DEFAULT NULL');
    }
