 ...
 */
final class Version20220401132019 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wallet CHANGE etherium etherium DOUBLE PRECISION DEFAULT NULL, CHANGE bitcoin bitcoin DOUBLE PRECISION DEFAULT NULL, CHANGE cometpoin cometpoin DOUBLE PRECISION DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wallet CHANGE etherium etherium INT DEFAULT NULL, CHANGE bitcoin bitcoin INT DEFAULT NULL, CHANGE cometpoin cometpoin INT DEFAULT NULL');
    }
}
