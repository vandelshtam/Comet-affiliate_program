 ...
 */
final class Version20220505081421 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction_table ADD type INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction_table DROP type, CHANGE cash cash VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
