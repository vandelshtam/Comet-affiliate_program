 ...
 */
final class Version20220407130021 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE personal_data_id personal_data_id INT DEFAULT NULL, CHANGE personal_code pesonal_code VARCHAR(255) DEFAULT NULL');
    }
