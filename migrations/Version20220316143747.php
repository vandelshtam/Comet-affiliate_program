 ...
 */
final class Version20220316143747 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE list_referral_networks (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, referral_networks_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, owner_name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE list_referral_networks');
