 ...
 */
final class Version20220318153008 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE referral_network DROP pakege_id');
    }
