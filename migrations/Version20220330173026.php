 ...
 */
final class Version20220330173026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE referral_network ADD pakage INT DEFAULT NULL');
    }
