 ...
 */
final class Version20220421113223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE setting_options CHANGE fast_start fast_start DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE setting_options CHANGE fast_start fast_start INT DEFAULT NULL, CHANGE name_multi_pakage name_multi_pakage VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
