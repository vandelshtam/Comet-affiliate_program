 ...
 */
final class Version20220405060611 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE referral_network ADD reward_wallet INT DEFAULT NULL');
    }
