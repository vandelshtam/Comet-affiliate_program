 ...
 */
final class Version20220415062825 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE list_referral_networks DROP created_at, DROP updated_at');
        $this->addSql('ALTER TABLE pakege DROP updated_at, CHANGE created_at created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE referral_network DROP created_at, DROP updated_at');
