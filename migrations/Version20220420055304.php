 ...
 */
final class Version20220420055304 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE setting_options ADD multi_pakage_day VARCHAR(255) DEFAULT NULL, ADD name_multi_pakage VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE setting_options DROP multi_pakage_day, DROP name_multi_pakage');
