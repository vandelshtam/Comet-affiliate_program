 ...
 */
final class Version20220328165751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pakege CHANGE referral_networks_id referral_networks_id VARCHAR(255) DEFAULT NULL');
    }
