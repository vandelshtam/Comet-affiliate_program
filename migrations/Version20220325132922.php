 ...
 */
final class Version20220325132922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD referral_link VARCHAR(255) DEFAULT NULL');
    }
