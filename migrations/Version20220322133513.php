 ...
 */
final class Version20220322133513 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE referral_network ADD koef DOUBLE PRECISION DEFAULT NULL');
    }
